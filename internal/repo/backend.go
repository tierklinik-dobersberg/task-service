...
type TaskBackend interface {
	...
	FilterTasks(ctx context.Context, boardId string, q map[taskql.Field]taskql.Query, groupBy string, pagination *commonv1.Pagination) ([]*tasksv1.TaskGroup, int, error)
